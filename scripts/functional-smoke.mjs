...
const tests = [
  ...
  ['Server: SMS endpoint requires authentication, not admin role', (() => { const s = files.server.slice(files.server.indexOf('/api/trigger-sms')); return s.includes('requireAuthenticatedUser') && !s.includes('requireAdmin'); })()],
