  ...
  const renderFeed = () => {
    ...
    return (
      <div className="flex-1 flex flex-col w-full bg-[#f8fafc] dark:bg-slate-905 pb-32 font-sans">
        ...
        <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-20 shadow-xs backdrop-blur-md bg-white/95 dark:bg-slate-900/95">
          <div className="max-w-6xl mx-auto p-3 sm:p-4 space-y-3">
            {/* Search Input Row */}
            <div className="flex items-center gap-2">
              <div className="relative flex-1 flex items-center bg-slate-100/90 hover:bg-slate-100 focus-within:bg-white focus-within:ring-2 focus-within:ring-[#008fe2]/20 border border-slate-200/80 rounded-full px-3.5 py-2 transition-all">
              ...
              <div className="relative shrink-0">
                <select
                  ...
                  className="bg-slate-100 hover:bg-slate-150 border border-slate-200/80 text-slate-700 text-[11px] font-bold py-2 px-3 rounded-full outline-none cursor-pointer transition-colors"
                >
            ...
            <div className="flex items-center justify-between gap-2 pt-0.5">
              ...
              <div className="flex items-center gap-1 bg-slate-100 p-1 rounded-xl border border-slate-200/80 shrink-0 overflow-x-auto no-scrollbar">
                <button
                  type="button"
        ...
        {/* Main Body Content */}
        <div className="max-w-6xl mx-auto w-full p-3 sm:p-5 space-y-5">
          {/* MAP RADAR VIEW MODE */}
          {feedViewMode === 'map' ? (
